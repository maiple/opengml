...
void bytecode_dis(bytecode::BytecodeStream in, std::vector<DisassembledBytecodeInstruction>& outInstructions, const Library* library, bool porcelain)
{
    using namespace opcode;
    while (true)
    {
        ...
        {
            instruction_dis<false>(in, op, ss, library);
        }

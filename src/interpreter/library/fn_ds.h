...
FNDEF3(ds_grid_resize, i, w, h)

///// queue data structure /////
FNDEF0(ds_queue_create)
FNDEF1(ds_queue_destroy, i)
FNDEF1(ds_queue_copy, i)
FNDEF1(ds_queue_clear, i)
FNDEF1(ds_queue_empty, i)
FNDEF1(ds_queue_size, i)
FNDEF2(ds_queue_enqueue, i, v)
FNDEF1(ds_queue_dequeue, i)
FNDEF1(ds_queue_head, i)
FNDEF1(ds_queue_tail, i)

///// priority queue data structure /////

FNDEF0(ds_priority_create)
FNDEF1(ds_priority_empty, id)
FNDEF1(ds_priority_size, id)
FNDEF1(ds_priority_clear, id)
FNDEF3(ds_priority_add, id, value, priority)
FNDEF1(ds_priority_delete_min, id)
FNDEF1(ds_priority_delete_max, id)
FNDEF1(ds_priority_find_min, id)
FNDEF1(ds_priority_find_max, id)

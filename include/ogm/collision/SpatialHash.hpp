...
public:
    ...
    void remove(leaf_index_t l)
    {
        ...
        while(!leaf.m_containers.empty())
        {
            ...
            // ogm_assert leaf was in container before it is removed.
            ogm_assert(iter != node_container.end());
    ...
    void clear()
    {
        for (size_t i = 0; i < k_bucket_count; ++i)
        {
            m_nodes[i].m_leaf_indices.clear();
        }
